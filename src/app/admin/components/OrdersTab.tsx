...
export function OrdersTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ERROR (NON-BLOCKING) */}
      {error && (
        <div className="p-3 rounded-md bg-red-950/40 border border-red-500/20 text-red-300 text-sm">
          Oops! Your order could not be fetched. Please try again.
        </div>
      )}

      {/* LOADING INDICATOR (SMALL, NOT BLOCKING) */}
      {isFetching && (
        <div className="text-xs text-zinc-400">Updating results...</div>
      )}
